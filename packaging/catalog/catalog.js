...
_.extend(LayeredCatalog.prototype, {
  ...
  _returnFirst: function (f, args, validityOracle) {
    ...
    var self = this;
    var result = (_self$localCatalog = self.localCatalog)[f].apply(_self$localCatalog, args);
    if (validityOracle(result)) {
      return result;
    }
    return (_self$otherCatalog = self.otherCatalog)[f].apply(_self$otherCatalog, args);
  },
