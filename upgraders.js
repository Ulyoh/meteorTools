var _cliMainJs = require('./cli/main.js');

var _cliMainJs2 = babelHelpers.interopRequireDefault(_cliMainJs);
...
var upgradersByName = {
  ...
  "1.2.0-cordova-changes": function (projectContext) {
    ...
    if (files.exists(pluginsFile.filename)) {
      messages = _utilsBuildmessageJs2['default'].capture({ title: 'converting Cordova plugins' }, function () {
